<!--This page is for sign out confirmation-->

<?php
/**
 * File Name: signOutConfirmation.php
 * Created by PhpStorm
 * User: ryand
 * Date: 7/26/2018
 * Time: 12:15 PM
    ...
    <form>
        <div id="completeRow" class="col-md-12">
            <div>
                ...
                <h2 class="text-center">We hope to see you again soon. Thank you for visiting Linemaster.</h2>
            </div>
        </div>
        <div class="row">
